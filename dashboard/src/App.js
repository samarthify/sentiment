...
const menuItems = [
  { text: t => t('general.dashboard'), icon: <DashboardIcon />, path: '/' },
  { text: t => t('analysis.sentimentAnalysis'), icon: <TimelineIcon />, path: '/sentiment' },
  { text: t => t('app.sentimentData'), icon: <TableChartIcon />, path: '/sentiment-data' },
  { text: t => t('analysis.geographicalInsights'), icon: <LanguageIcon />, path: '/geographic' },
  { text: t => t('general.analytics'), icon: <AnalyticsIcon />, path: '/analytics' },
  { text: t => t('general.settings'), icon: <SettingsIcon />, path: '/settings' },
];
            ...
            <Box component="main" sx={{ flexGrow: 1, p: 0, width: '100%', overflowX: 'hidden' }}>
              ...
              <ContentContainer>
                <Routes>
                  <Route path="/" element={
                    loading ? (
                      ...
                      <Grid container spacing={3} sx={{ maxWidth: '100%' }}>
                          ...
                          <Grid container spacing={3} direction="column">
                            <Grid item xs={12}>
                              <Paper elevation={0} sx={{ p: 2 }}>
                                <SentimentTable
                                  data={filteredData}
                                  title={t('sentimentTable.highestSentiment')}
                                  type="top"
                                />
                              </Paper>
                            </Grid>
                            <Grid item xs={12}>
                              <Paper elevation={0} sx={{ p: 2 }}>
                                <SentimentTable
                                  data={filteredData}
                                  title={t('sentimentTable.lowestSentiment')}
                                  type="bottom"
                                />
                              </Paper>
                            </Grid>
                        ...
                        {/* Influencer Analysis */}
                        <Grid item xs={12} id="influencer-analysis">
                          <Paper elevation={0} sx={{ p: 2 }}>
                            <InfluencerAnalysis data={filteredData} />
                          </Paper>
                        </Grid>

                        {/* Platform Sentiment */}
                        <Grid item xs={12} id="platform-sentiment">
                          <Paper elevation={0} sx={{ p: 2 }}>
                            <PlatformSentiment data={filteredData} />
                          </Paper>
                        </Grid>
                  ...
                  <Route path="/platform-sentiment" element={<PlatformSentiment />} />
                  <Route path="/theme-analysis" element={<ThemeAnalysis />} />
                  <Route path="/influencer-analysis" element={<InfluencerAnalysis />} />
